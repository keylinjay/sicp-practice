...
(defun set-value! (connector new-value informant)
  (funcall (funcall connector 'set-value!) 
	   new-value
	   informant))
(defun forget-value! (connector retractor)
  (funcall (funcall connector 'forget)
	   retractor))
(defun connect (connector new-constraint)
  
  (show (funcall connector 'connect))
  (funcall (funcall connector 'connect)
	   new-constraint))
...
(celsisus-fahrenheit-converter *C* *F*)
